  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>
            With a focus on innovatino, hands-on learning, and personalized mentorship, our programs prepare aspiring edicators to make a meaningful impact in classrooms, schools, and communities.
        </p>
        <p>
