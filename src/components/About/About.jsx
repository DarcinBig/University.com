  ...
  return (
    <div className='about'>
      <div className="about-left">
        ...
        <img src={play_icon} alt="play icon" className='play-icon' onClick={() => {props.setPlayState(true)}} />
      </div>
      <div className="about-right">
        ...
        <p>
            With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring edicators to make a meaningful impact in classrooms, schools, and communities.
        </p>
        <p>
